						...
						<table class="table table-striped table-hover">
							<thead>
								<tr>
									...
									<th scope="col">Paddy Id</th>
									<th scope="col">Paddy Type</th>
									<th scope="col">Buying Price (Rs/1kg)</th>
									<th scope="col">Selling Price (Rs/1kg)</th>													
								</tr>
							</thead>
							<tbody>							
								<c:forEach var="collectPaddyPriceList"
									items="${listPaddyPricing}">
									<tr>
										<td><c:out value="${collectPaddyPriceList.paddy_Id}" /></td>
										<td><c:out value="${collectPaddyPriceList.paddy_Type}" /></td>
										<td><c:out value="Rs.${collectPaddyPriceList.buying_price_per_Kg}" /></td> 
										<td><c:out value="Rs.${collectPaddyPriceList.selling_price_per_Kg}" /></td>																												
									</tr>
								</c:forEach>
							</tbody>
						</table>
